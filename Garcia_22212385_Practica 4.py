...
# Función de transferecia: Normotenso
Z,C,R,L = 0.033,1.5,0.95,0.01
sysnormo = cardio(Z,C,R,L)
print(f'Funcion de transferencia de normotenso: {sysnormo}')

# Función de transferecia: Hipotenso
Z,C,R,L = 0.02,0.25,0.6,0.005
syshipo = cardio(Z,C,R,L)
print(f'Funcion de transferencia de hipotenso: {syshipo}')

# Función de transferecia: Hipertenso
Z,C,R,L = 0.05,2.5,1.4,0.02
syshiper = cardio(Z,C,R,L)
print(f'Funcion de transferencia de hipertenso: {syshiper}')
...
plt.plot(t,Pp2,'-' ,linewidth=1,color=[0.90,0.15,0.15],label='Pp(t):Hipertenso')
plt.grid(False)
...
hipoPI = controlador(27.3934,41929.1691,syshipo)
hiperPI = controlador(866.1405,1111406.1001,syshiper)
...
plt.plot(t,Pp0,'-' ,linewidth=1,color=[0.93,0.64,0.35],label='Pp(t):Normotenso')
plt.plot(t,Pp1,'-' ,linewidth=1,color=[0.23,0.67,0.20],label='Pp(t):Hipotenso')
plt.plot(t,Pp3,':' ,linewidth=3,color=[0.50,0.50,0.50],label='Pp(t):Hipotenso-PI')
plt.grid(False)
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t) [V]')
...
fg3 = plt.figure()
plt.plot(t,Pp0,'-' ,linewidth=1,color=[0.93,0.64,0.35],label='Pp(t):Normotenso')
plt.plot(t,Pp2,'-' ,linewidth=1,color=[0.23,0.67,0.20],label='Pp(t):Hipertenso')
plt.plot(t,Pp4,':' ,linewidth=3,color=[0.50,0.50,0.50],label='Pp(t):Hipertenso-PI')
plt.grid(False)
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(-0.6,1.4); plt.yticks(np.arange(-0.6,1.6,0.2))
plt.xlabel('Pp(t) [V]')
